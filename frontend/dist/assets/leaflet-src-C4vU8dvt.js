import { i as e } from './index-ConJB3HE.js'
var t = e((e, t) => {
  ;(function (n, r) {
    ...
    T.prototype = {
      extend: function (e) {
        ...
        return (
          !t && !n
            ? ((this._southWest = new D(r.lat, r.lng)),
      ...
      contains: function (e) {
        e =
          typeof e[0] == `number` || e instanceof D || `lat` in e ? O(e) : E(e)
        var t = this._southWest,
          n = this._northEast,
          r,
          i
    ...
    me.prototype = {
      ...
      untransform: function (e, t) {
        return (
          (t ||= 1),
          new x((e.x / t - this._b) / this._a, (e.y / t - this._d) / this._c)
        )
      },
    }
    function he(e, t, n, r) {
      ...
      W = ue.extend({
        ...
        initialize: function (e, t) {
          ;((t = p(this, t)),
            ...
            t.center &&
              t.zoom !== void 0 &&
              this.setView(O(t.center), t.zoom, { reset: !0 }),
            this.callInitHooks(),
            (this._zoomAnimated =
        ...
        project: function (e, t) {
          return (
            (t = t === void 0 ? this._zoom : t),
            this.options.crs.latLngToPoint(O(e), t)
          )
        },
        unproject: function (e, t) {
          return (
            (t = t === void 0 ? this._zoom : t),
            this.options.crs.pointToLatLng(S(e), t)
          )
        },
    ...
    function Hn(e, t) {
      ...
      if (r === 0) l = p[0]
        ...
        for (n = 0, a = 0; n < f - 1; n++)
          if (
            ((o = p[n]), (s = p[n + 1]), (i = o.distanceTo(s)), (a += i), a > r)
          ) {
            ;((c = (a - r) / i),
    ...
    var X = ar.extend({
      ...
      closestLayerPoint: function (e) {
        for (
          var t = 1 / 0, n = null, r = Bn, i, a, o = 0, s = this._parts.length;
          o < s;
          o++
        )
      ...
      _convertLatLngs: function (e) {
        for (var t = [], n = q(e), r = 0, i = e.length; r < i; r++)
          n
            ? ((t[r] = O(e[r])), this._bounds.extend(t[r]))
          ...
          if (t in this._panKeys) {
            if (!n._panAnim || !n._panAnim._inProgress)
              if (
                ...
                n.options.maxBounds &&
                  (r = n._limitOffset(S(r), n.options.maxBounds)),
